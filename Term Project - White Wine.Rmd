...
fixed.cen = (14.2 - mean(white.wine$fixed.acidity))
vol.cen = (1.1 - mean(white.wine$volatile.acidity))
citric.cen = (1.6 - mean(white.wine$citric.acid))
resid.cen = (65.8 - mean(white.wine$residual.sugar))
chlor.cen = (0.346 - mean(white.wine$chlorides))
free.cen = (289 - mean(white.wine$free.sulfur.dioxide))
tot.cen = (440 - mean(white.wine$total.sulfur.dioxide))
dens.cen = (1.04 - mean(white.wine$density))
ph.cen = (3.82 - mean(white.wine$pH))
sul.cen = (1.08 - mean(white.wine$sulphates))
alc.cen = (14.2 - mean(white.wine$alcohol))
