...
fixed.cen = (white.wine$fixed.acidity - mean(white.wine$fixed.acidity))
vol.cen = (white.wine$volatile.acidity - mean(white.wine$volatile.acidity))
citric.cen = (white.wine$citric.acid - mean(white.wine$citric.acid))
resid.cen = (white.wine$residual.sugar - mean(white.wine$residual.sugar))
chlor.cen = (white.wine$chlorides - mean(white.wine$chlorides))
free.cen = (white.wine$free.sulfur.dioxide - mean(white.wine$free.sulfur.dioxide))
tot.cen = (white.wine$total.sulfur.dioxide - mean(white.wine$total.sulfur.dioxide))
dens.cen = (white.wine$density - mean(white.wine$density))
ph.cen = (white.wine$pH - mean(white.wine$pH))
sul.cen = (white.wine$sulphates - mean(white.wine$sulphates))
alc.cen = (white.wine$alcohol - mean(white.wine$alcohol))
white.datapoints = c(6, fixed.cen, vol.cen, citric.cen, resid.cen, chlor.cen, free.cen, tot.cen, dens.cen, ph.cen, sul.cen, alc.cen)
