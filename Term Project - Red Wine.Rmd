...
Unfortunately, deleting the point increases the $R^2$ and decreases the mean squared error value by just a little bit, which is not as desirable. Hence, we conclude that the points 152, 653, and 1236 are not influential.
...
best meets our criterion, which perfectly aligns with our expectation we had when we saw the large P-values in the full model.
